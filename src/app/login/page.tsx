    ...
    <>
      ...
      <div className="mt-6">
        ...
        <button
          ...
          className="mt-4 w-full flex justify-center items-center gap-3 py-3 px-4 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 font-medium text-gray-700 transition-all"
        >
      ...
      <div className="mt-6">
        ...
        <div className="mt-6">
          <Link
            href="/quote"
            className="w-full flex justify-center items-center gap-2 py-3 px-4 border border-gray-200 rounded-xl text-gray-700 bg-white hover:bg-gray-50 font-medium transition-all"
          >
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Access your translation portal
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-6 text-center text-xs text-gray-500">
          For linguist applications, please visit the{' '}
          <Link href="/translators" className="text-blue-600 hover:underline">
            Translators
          </Link>{' '}
          page.
        </p>
